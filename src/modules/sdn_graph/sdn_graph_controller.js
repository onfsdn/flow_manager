...
// Returns a list of all nodes under the root.
    ...
    function get_popuptable(k) {
        ...
        table_text = table_text + "<tr><th><span styel='cursor:pointer;color:red'></span><i title='Delete' class='fa fa-fw fa-remove' onclick=flow_delete('" + k._id + "','" + k._rev + "') ></i></th><th><a href='#/sdn_edit_flow/" + k._id + "'><i title='Update flow' class='fa fa-fw fa-edit' ></i></a></th></tr>";
